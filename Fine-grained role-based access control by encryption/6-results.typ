...
The values can be seen in more details in more details in @app:micro, but essentially the _p99_ time for unwrapping key size 256 of a tiny file is _4.11 seconds_, with a mean of _3.92 seconds_, meaning that caching the unwrapped DEKs are essential.
