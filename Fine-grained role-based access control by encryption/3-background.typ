...
It is meant to provide fine-grained role-based access control by encryption at the columnar level.
...
In OSWS, TTL defines the lifetime of unwrapped DEKs in memory.
